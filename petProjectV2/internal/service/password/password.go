...
func EncryptPass(pass string, config *config.Config) (string, error) {

	block, err := aes.NewCipher([]byte(config.Password.Key))
...
func DecryptPass(envPass string, config *config.Config) (string, error) {
